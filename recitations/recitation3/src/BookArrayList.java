 ...
 */
public class BookArrayList<E> implements List<E> {
  // instance variables
  ...
  public BookArrayList() { this(CAPACITY); }   // constructs list with default capacity

  /** Creates an array list with given initial capacity. */
  @SuppressWarnings({"unchecked"})
  public BookArrayList(int capacity) {         // constructs list with given capacity
  ...
  private class ArrayIterator implements Iterator<E> {
    ...
    public void remove() throws IllegalStateException {
      ...
      BookArrayList.this.remove(j-1);  // that was the last one returned
